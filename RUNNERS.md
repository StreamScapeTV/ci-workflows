...
| Measured larger general work | `general-medium` | `[linux, amd64, general, medium]` | 1 / 4 Gi memory; 16 Gi local storage; 8 Gi disposable workspace | Opt in only through an API that explicitly permits the measured medium tier |
