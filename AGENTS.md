...
- The repository-level Google Drive folder ID above is a durable identity. Reuse it for source snapshots and never create or delete another `repositories/ci-workflows` project folder as part of normal CI or branch cleanup. Branch/ref folders below it remain disposable under the shared lifecycle rules.
