...
IOS_AUDIO_DERIVE_BLOB_SHA1 = "dca798a49adf036b34132b0435dd70d0791bfa7a"
IOS_AUDIO_VALIDATE_PATH = "scripts/ci/test-validate-ios-audio-output-evidence.py"
IOS_AUDIO_VALIDATE_BLOB_SHA1 = "0dabf33585bb0b55230c76ce3bf255e1dcacb2a1"
REVIEWED_MEDIA_SENTINELS = {
    ...
    IOS_AUDIO_DERIVE_PATH: IOS_AUDIO_DERIVE_BLOB_SHA1,
    IOS_AUDIO_VALIDATE_PATH: IOS_AUDIO_VALIDATE_BLOB_SHA1,
}
MEDIA_TASKS = {
