...
""",
    ...
    def test_screenshot_review_is_fixed_two_lane_repository_evidence_profile(self) -> None:
        ...
        self.assertIn('workspace_dirty="$(git status --porcelain --untracked-files=normal)"', block)
        self.assertIn('test -z "${workspace_dirty}"', block)
        self.assertIn('export PYTHONDONTWRITEBYTECODE=1', block)
