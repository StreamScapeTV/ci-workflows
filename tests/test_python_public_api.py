...
class PythonPublicApiTests(unittest.TestCase):
    ...
    def test_python_inputs_outputs_and_consumers_are_exact(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(
            set(self.python["supported_consumers"]),
            {
    ...
    def test_generated_public_reference_contains_the_implemented_python_api(self) -> None:
        ...
        self.assertNotIn("postgres_enabled", rendered.split("### `validation.python`", 1)[1].split("### `", 1)[0])
