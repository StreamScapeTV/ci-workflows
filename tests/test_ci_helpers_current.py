...
class CiHelperTests(_prior.CiHelperTests):
    ...
    def test_inventory_is_the_only_inventory_and_matches_the_small_surface(self) -> None:
        ...
        self.assertEqual(set(inventory["scripts"]), {"oci_reproducibility", "ci_log_reconcile", "github_issue_dependency_projection", "repository_log_checkpoint", "repository_log_capture", "repository_log_timeline", "source_snapshot_delete", "source_snapshot_lifecycle", "source_checkpoint_publish", "swiftpm_binary"})
