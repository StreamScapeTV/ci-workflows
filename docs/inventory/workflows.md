...
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle caller | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `415225b806e3b334753c43599c65d741f845d4ae` |
| `.github/workflows/agent-state-lifecycle.yml` | Reusable Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `1b77021c11a4b29257d470f6ac60b6ec0c44c8b3` |
| `.github/workflows/agent-state-ownership.yml` | Reusable Agent State ownership | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `a6a0f48ade6f31eb99ec627d45387481fd4da52b` |
...
| Workflow | Name | Status | Disposition | Migration | Trust | Blob |
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `7cabbb4a72e1fe8fb2160f70a6585fa137e60957` |
| `.github/workflows/agent-state-ownership.yml` | Agent State ownership | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `aadb2ce722cb525151a24ff0298c2daa4d0b0c02` |
...
| Workflow | Name | Status | Disposition | Migration | Trust | Blob |
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `604efbf6db5de99ef368a6cf0e2907e038a2ca4b` |
...
| Workflow | Name | Status | Disposition | Migration | Trust | Blob |
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `595d4bff2ae596fcacf9aaaa33774e656122e033` |
...
| Workflow | Name | Status | Disposition | Migration | Trust | Blob |
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | — |
...
| `.github/workflows/pr-agent-state-policy.yml` | PR Agent State policy | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | — |
...
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State lifecycle | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | — |
| `.github/workflows/agent-state-ownership.yml` | Agent State ownership | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | — |
...
| Workflow | Name | Status | Disposition | Migration | Trust | Blob |
|---|---|---|---|---|---|---|
| `.github/workflows/agent-state-claim.yml` | Agent State Claim Bridge | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `18ccfce8723b37f27f056db262a517aeb52ea2d8` |
| `.github/workflows/agent-state-ownership.yml` | Agent State ownership | `legacy-file-present-operating-path-retired` | `retire` | `retire` | `legacy-agent-state` | `8f10a7f7d546214e79543d4e0ad2f04a9bdba6f1` |
