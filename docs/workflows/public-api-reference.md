...
| `validation.gitops` `1.0.0` | `.github/workflows/reusable-gitops-validation.yml` | `planned` | `read-only-validation` | `portable` | `CI / GitOps source validation` | StreamScapeTV/flux, StreamScapeTV/iptv-backend, StreamScapeTV/agent-state, StreamScapeTV/organization-rules | — |
