...
def execute_network(args: argparse.Namespace, context: CIWContext) -> CIWResult:
    ...
    try:
        if operation == "download":
            ...
            relative = _text(_value(args, context, "relative_path"), "relative_path_required", maximum=4096)
            ...
            maximum = _integer(args, context, "maximum_bytes", 512 * 1024 * 1024, 8 * 1024 * 1024 * 1024)
        ...
        if operation == "verify":
            ...
            return _result("verify", size=result.size, sha256=result.sha256)
        if operation == "extract":
            ...
            result = extract_archive(
                archive,
                archive_format=_text(_value(args, context, "archive_format"), "archive_format_required"),
